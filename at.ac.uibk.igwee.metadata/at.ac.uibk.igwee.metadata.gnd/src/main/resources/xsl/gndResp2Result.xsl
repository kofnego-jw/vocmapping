...
<xsl:stylesheet 
    ...
    <xsl:template match="srw:record">
        ...
        <gndVocabulary>
            ...
            <xsl:choose>
                <xsl:when test="srw:recordData//gndo:preferredNameForThePerson">
                    <vocabularyType>PERSONAL_NAME</vocabularyType>
                    <name><xsl:value-of select="srw:recordData//gndo:preferredNameForThePerson"/></name>
                </xsl:when>
                <xsl:when test="srw:recordData//gndo:preferredNameForTheCorporateBody">
                    <vocabularyType>INSTITUTION_NAME</vocabularyType>
                    <name><xsl:value-of select="srw:recordData//gndo:preferredNameForTheCorporateBody"/></name>
                </xsl:when>
                <xsl:when test="srw:recordData//gndo:preferredNameForThePlaceOrGeographicName">
                    <vocabularyType>PLACE_NAME</vocabularyType>
                    <name><xsl:value-of select="srw:recordData//gndo:preferredNameForThePlaceOrGeographicName"/></name>
                </xsl:when>
                <xsl:otherwise>
